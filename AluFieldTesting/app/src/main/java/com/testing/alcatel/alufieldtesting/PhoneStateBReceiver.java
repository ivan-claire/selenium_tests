...
public class PhoneStateBReceiver extends BroadcastReceiver {
    ...
    public void setCsVoiceCallsHandler(CsVoiceCalls main){
        yourMain = main;
    }
                    ...
                    if((prev_state==TelephonyManager.CALL_STATE_OFFHOOK)){
                        ...
                        handler2.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                System.err.print("\n CHECKKKKKKKKKKKK INCOMMING CAAAAAAAAAALLLLLLL");
                                if (incoming) {
                                    System.err.print("\nIncoming::::::"+incoming);
